...
from cpqdasr.audio_source import FileAudioSource, BufferAudioSource
...
def testEquivalenceFileBuffer():
    ...
    source.finish()
    result_buffer = asr.waitRecognitionResult()[0].alternatives[0]['text']
    asr.close()
